...
def save_ckpt(model, optimizer,optimizer2, config, ckpt_file, epoch, model_val):
    torch.save({
        'config': config,
        'epoch': epoch,
        'model_val': model_val,
...
def load_ckpt(ckpt_file):
    ...
    optimizer2 = ckpt['optimizer2']
    current_epoch = ckpt['epoch']
    model_val = ckpt['model_val']
    return config, model, optimizer,optimizer2, current_epoch, model_val
