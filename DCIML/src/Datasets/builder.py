...
#
# from src.Utils.basic_utils import BigFile, read_dict
# from src.Datasets.data_provider import Dataset4PRVR, VisDataSet4PRVR, TxtDataSet4PRVR, \
...
from Datasets.data_provider import Dataset4PRVR, VisDataSet4PRVR, TxtDataSet4PRVR, \
                    collate_train,collate_test, collate_frame_val, collate_text_val, read_video_ids
...
def get_datasets(cfg):
    ...
    test_dataset = Dataset4PRVR(caption_files['test'], visual_feats, text_feat_path, cfg, video2frames=video2frames)
    ...
    grounding_loader = DataLoader(dataset=test_dataset,
                              batch_size=cfg['batchsize'],
                              shuffle=False,
                              pin_memory=cfg['pin_memory'],
                              num_workers=cfg['num_workers'],
    ...
    return cfg, train_loader,grounding_loader, context_dataloader, query_eval_loader, test_context_dataloader, test_query_eval_loader